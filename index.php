...
<html lang="en">
  ...
  <body>
    ...
    foreach ($database as $array):
       foreach ($array as $contentArray => $value):
        if ($contentArray == "domanda") {
          echo "<div class='domanda'><h2>$value</h2></div>";
        } elseif ($contentArray == "risposta") {
          echo "<div class='risposta'><p>$value</p></div>";
        }
      endforeach;
    endforeach;
